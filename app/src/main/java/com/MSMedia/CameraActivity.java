...
public class CameraActivity extends AppCompatActivity {
    ...
    private int cameraIdValue = 1;
    boolean frontCameraOpen = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            FloatingActionButton takePictureButton = findViewById(R.id.clickPhoto);
            ...
            ImageView flipCameraButton = findViewById(R.id.flipCamera);
            flipCameraButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.i("camera", "flipped");
                    if (cameraIdValue == 1){
                        cameraIdValue = 0;
                        closeCamera();
                        openCamera();
                    ...
                    Log.i("camera value", ""+ cameraIdValue);
//                    createCameraPreview();
                }
            });
        }
    ...
    private void openCamera() {
        ...
        try {
            String cameraId = manager.getCameraIdList()[cameraIdValue];
